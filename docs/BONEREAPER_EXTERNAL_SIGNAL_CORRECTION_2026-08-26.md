...
Status: **RECOVERED PILOT CORRECTION — DESCRIPTIVE ONLY**

The correction was written before the surviving recomputation artifact, but its claimed Git commit
is not present in the recovered repository. It documents the dated rule fix and the immutable
recomputation inputs; it does not restore the missing prospective commit boundary.
